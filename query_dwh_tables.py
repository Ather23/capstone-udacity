...
class TableOperations:
    ...
    def drop_all_tables(self):
        qrys = [
            ...
            "drop table IF EXISTS dim_collision_loc_table;",
    ...
    def create_collision_tables(self):
        tables_to_create = [
            ...
            collision_sql_tables.create_dim_station_table,
            collision_sql_tables.create_dim_bike_trips_table,
    ...
    def insert_fact_and_dim_tables(self):
        tbls_to_insert = [
            ...
            # # collision_sql_tables.insert_collision_table,
            # collision_sql_tables.insert_zip_codes,
            # collision_sql_tables.insert_start_station_table,
            # collision_sql_tables.insert_end_station_table
        ]
